...
describe('Profile Management Update Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [HttpClientTestingModule, ProfileUpdateComponent],
      providers: [
        FormBuilder,
        {
  ...
  describe('ngOnInit', () => {
    it('Should call User query and add missing value', () => {
      ...
      const internalUser: IUser = { id: 2092 };
      profile.internalUser = internalUser;
    ...
    it('Should update editForm', () => {
      const profile: IProfile = { id: 456 };
      const internalUser: IUser = { id: 4209 };
      profile.internalUser = internalUser;
