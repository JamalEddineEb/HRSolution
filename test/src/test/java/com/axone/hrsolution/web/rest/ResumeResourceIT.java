...
class ResumeResourceIT {
    ...
    public static Resume createEntity(EntityManager em) {
        Resume resume = new Resume().file(DEFAULT_FILE).fileContentType(DEFAULT_FILE_CONTENT_TYPE).filename(DEFAULT_FILENAME);
        return resume;
    }
    ...
    public static Resume createUpdatedEntity(EntityManager em) {
        Resume resume = new Resume().file(UPDATED_FILE).fileContentType(UPDATED_FILE_CONTENT_TYPE).filename(UPDATED_FILENAME);
        return resume;
    }
    ...
    void putExistingResume() throws Exception {
        ...
        updatedResume.file(UPDATED_FILE).fileContentType(UPDATED_FILE_CONTENT_TYPE).filename(UPDATED_FILENAME);
    ...
    void partialUpdateResumeWithPatch() throws Exception {
        ...
        partialUpdatedResume.file(UPDATED_FILE).fileContentType(UPDATED_FILE_CONTENT_TYPE).filename(UPDATED_FILENAME);
