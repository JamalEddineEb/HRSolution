...
public class CandidateTestSamples {
    ...
    public static Candidate getCandidateSample1() {
        return new Candidate().id(1L).linkedinUrl("linkedinUrl1").fullName("fullName1").yearsOfExperience(1);
    }

    public static Candidate getCandidateSample2() {
        return new Candidate().id(2L).linkedinUrl("linkedinUrl2").fullName("fullName2").yearsOfExperience(2);
    }
